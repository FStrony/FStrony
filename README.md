...
I'm a **Senior Software Engineer and Technical Consultant** with 10+ years of experience across backend engineering, APIs, integrations, databases, cloud platforms and legacy systems.

My strongest focus today is **Java, Spring Boot, AWS, microservices and asynchronous integrations**. My broader experience across .NET, Ruby, PHP and frontend systems helps me understand the whole system rather than a single layer.

---

## 🧭 About me

- 💻 Senior Software Engineer focused on backend engineering and system architecture
- ☁️ Experienced with **AWS, cloud integrations and distributed systems**
...
Experience designing, developing and maintaining software across different business domains and technical environments, including:

- Backend services with Java and Spring Boot
- REST APIs and system integrations
- AWS cloud integrations
- SNS/SQS and asynchronous processing
- Microservice and event-driven architectures
- Relational and NoSQL databases
- Incremental legacy modernisation
- Reliability, maintainability and automated testing
...
I spent **four years in Australia**, studying software development and project management while living in an international environment.
...
For architecture-focused case studies and a complete overview of my professional profile:

👉 **[Visit my portfolio](https://fstrony.github.io)**

Professional case studies are intentionally described at a high level to respect client and employer confidentiality.
